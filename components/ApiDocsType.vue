  ...
  computed: {
    ...
    item() {
      ...
      if (type.deprecated) {
        ...
        type.desc =
          `<div class="warning custom-block"><p class="custom-block-title">DEPRECATED${
            type.deprecated.since ? ` SINCE ${type.deprecated.since}` : ""
          }</p><p>
        Do not use for new work.${
          type.deprecated.use ? ` Use [[${type.deprecated.use}]] instead.` : ""
        }
        </p></div>` + type.desc;
      }
